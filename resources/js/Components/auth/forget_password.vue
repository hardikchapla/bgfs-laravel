            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-form">
                        ...
                        <h2>
                            <span class="t-primary">Hi</span>, reset your password
                        </h2>
                        <div class="heading-bar">
                            <span></span>
                            <span></span>
                        ...
                        <form v-else @submit="_reset_password_user">
                            <h6><span class="bar"></span>Forget Password<span class="bar"></span></h6> 
                            
                            <label for="number">OTP *</label>
                            <input type="number" placeholder="Enter token sent to your email" v-model="otp" class="form-control" id="number" /> 
    ...
    methods: {
        _forget_password_user(e) {
            ...
            try {
                if ( 
                    ...
                    this.$swal.fire({
                        icon: 'error',
                        title: 'Email feild are required!'
                    });
                    return false;
                }
                let data = { 
                ...
                this.loading = true;
                axios.post(`/forget_password_user`, data)
                    .then(response => { 
        ...
        _reset_password_user(e) {
            ...
            try {
                ...
                this.loading = true;
                axios.post(`/reset_password_user`, data)
                    .then(response => { 
                        if (response.data.status == 1) {
                            this.$swal({
                                icon: 'success',
